...
import type { TimeEntry, Employee, Task } from '@/lib/types'
...
export function LiveActivity() {
    ...
    const isLoading = loadingEntries || loadingEmployees || loadingTasks;

    const activityData = useMemo<ActivityItem[]>(() => {
        if (!activeTimeEntries || !employees || !tasks) return []
    ...
    }, [activeTimeEntries, employees, tasks])
