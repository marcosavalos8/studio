                    ...
                    <FormItem>
                       <RadioGroup onValueChange={field.onChange} defaultValue={field.value} className="flex gap-4">
                          <FormItem className="flex items-center space-x-2">
                              <FormControl>
                                  <RadioGroupItem value="hourly" id="client-hourly-edit" />
                              </FormControl>
                              <FormLabel htmlFor="client-hourly-edit" className="font-normal">Hourly</FormLabel>
                          </FormItem>
                           <FormItem className="flex items-center space-x-2">
                              <FormControl>
                                  <RadioGroupItem value="piece" id="client-piece-edit" />
                              </FormControl>
                              <FormLabel htmlFor="client-piece-edit" className="font-normal">Piece</FormLabel>
                          </FormItem>
                       </RadioGroup>
                    </FormItem>
                  )}
                  ...
                  render={({ field }) => (
                    <FormItem>
                       <RadioGroup onValueChange={field.onChange} defaultValue={field.value} className="flex gap-4">
                          <FormItem className="flex items-center space-x-2">
                              <FormControl>
                                  <RadioGroupItem value="hourly" id="emp-hourly-edit" />
                              </FormControl>
                              <FormLabel htmlFor="emp-hourly-edit" className="font-normal">Hourly</FormLabel>
                          </FormItem>
                           <FormItem className="flex items-center space-x-2">
                              <FormControl>
                                  <RadioGroupItem value="piecework" id="emp-piece-edit" />
                              </FormControl>
                              <FormLabel htmlFor="emp-piece-edit" className="font-normal">Piecework</FormLabel>
                          </FormItem>
                       </RadioGroup>
                    </FormItem>
                  )}
