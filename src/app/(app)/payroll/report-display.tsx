                                                ...
                                                <AccordionContent className="space-y-4 pl-4">
                                                    ...
                                                    <Table>
                                                        <TableBody>
                                                            ...
                                                            {week.overtimeHours !== undefined && week.overtimeHours > 0 && (
                                                              <>
                                                                <TableRow className="bg-purple-50 dark:bg-purple-900/20">
                                                                  <TableCell className="font-medium">Overtime Hours (over 40/week)</TableCell>
                                                                  <TableCell className="text-right text-purple-600 font-medium">{week.overtimeHours.toFixed(2)} hrs</TableCell>
                                                                </TableRow>
                                                                <TableRow className="bg-purple-50 dark:bg-purple-900/20">
                                                                  <TableCell className="font-medium">Regular Rate for OT Calculation</TableCell>
                                                                  <TableCell className="text-right text-purple-600 font-medium">${week.regularRate?.toFixed(2) || '0.00'}/hr</TableCell>
                                                                </TableRow>
                                                                <TableRow className="bg-purple-50 dark:bg-purple-900/20">
                                                                  <TableCell className="font-medium">Overtime Premium (0.5x rate)</TableCell>
                                                                  <TableCell className="text-right text-purple-600 font-medium">+ ${week.overtimePremium?.toFixed(2) || '0.00'}</TableCell>
                                                                </TableRow>
                                                              </>
                                                            )}
